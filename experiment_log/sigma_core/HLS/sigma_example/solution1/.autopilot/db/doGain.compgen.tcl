...
set ID 1
set MemName doGain_valIn_data_V
...
# Memory (RAM/ROM)  definition:
set ID 2
set MemName doGain_valIn_keep_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 4
set AddrRange 10000
...
# Memory (RAM/ROM)  definition:
set ID 3
set MemName doGain_valIn_user_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 2
set AddrRange 10000
...
# Memory (RAM/ROM)  definition:
set ID 4
set MemName doGain_valIn_last_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 1
set AddrRange 10000
...
# Memory (RAM/ROM)  definition:
set ID 6
set MemName doGain_valIn_dest_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 6
set AddrRange 10000
