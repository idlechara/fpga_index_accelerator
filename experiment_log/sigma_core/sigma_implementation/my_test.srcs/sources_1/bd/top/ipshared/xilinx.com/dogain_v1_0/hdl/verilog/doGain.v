...
(* CORE_GENERATION_INFO="doGain,hls_ip_2015_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.080000,HLS_SYN_LAT=1006,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=149,HLS_SYN_LUT=155}" *)
...
assign exitcond_fu_134_p2 = (idx_reg_123 == ap_const_lv10_3E8? 1'b1: 1'b0);

assign idx_1_fu_140_p2 = (idx_reg_123 + ap_const_lv10_1);
